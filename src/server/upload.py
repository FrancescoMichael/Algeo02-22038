...
# UPLOAD_TEST = 'data/test'
# app.config['UPLOAD_TEST'] = UPLOAD_TEST

# UPLOAD_DATASET = 'data/dataset'
...
#         if 'urlForDataset' in request.form:
#             url_for_dataset = request.form['urlForDataset']
#             if url_for_dataset != '':
#                 image_for_dataset_path = os.path.join(app.config['UPLOAD_FOLDER'], 'image_for_dataset.png')
#                 download_image_from_url(url_for_dataset, image_for_dataset_path)
#             else:
#                 return jsonify({"error": "Empty URL for imageForDataset"}), 400
...
# Tambahkan path untuk menyimpan URL
UPLOAD_URL_FOLDER = 'data/url'
app.config['UPLOAD_URL_FOLDER'] = UPLOAD_URL_FOLDER
